...
if (__name__ == '__main__'):
    import tempfile
    for cls in (FlatShelf, PickleShelf, SQLiteShelf):
        fname = 'test_{}.db'.format(cls.__name__)
        filename = os.path.sep.join([os.path.dirname(tempfile.NamedTemporaryFile().name),fname])
        print(filename)
